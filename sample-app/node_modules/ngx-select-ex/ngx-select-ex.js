...
class NgxSelectComponent {
    ...
    constructor(iterableDiffers, sanitizer, cd, defaultOptions) {
        ...
        this.subjOptions
            ...
            this.optionsFilteredFlat()
                .filter((flatOptions) => this.autoSelectSingleOption && flatOptions.length === 1 && !selectedOptions.length)
    ...
    optionsFilteredFlat() {
        ...
        return Observable$1.from(this.optionsFiltered)
            .flatMap((option) => option instanceof NgxSelectOption ? Observable$1.of(option) :
    ...
    filterOptions(search, options, selectedOptions) {
        const /** @type {?} */ regExp = new RegExp(escapeString(search), 'i'), /** @type {?} */ filterOption = (option) => {
    ...
    optionsOpen(search = '') {
        if (!this.disabled) {
            ...
            if (!this.multiple && this.subjOptionsSelected.value.length) {
                this.optionsFilteredFlat().subscribe((options) => this.optionActivate({
