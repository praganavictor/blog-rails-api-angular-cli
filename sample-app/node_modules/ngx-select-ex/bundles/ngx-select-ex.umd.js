(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('@angular/forms'), require('@angular/platform-browser'), require('rxjs/Subject'), require('rxjs/Observable'), require('rxjs/BehaviorSubject'), require('rxjs/add/observable/empty'), require('rxjs/add/observable/from'), require('rxjs/add/observable/of'), require('rxjs/add/operator/distinctUntilChanged'), require('rxjs/add/operator/combineLatest'), require('rxjs/add/operator/mergeMap'), require('rxjs/add/operator/toArray'), require('rxjs/add/operator/filter'), require('rxjs/add/operator/share'), require('rxjs/add/operator/merge'), require('rxjs/add/operator/map'), require('rxjs/add/operator/do'), require('lodash'), require('escape-string-regexp')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@angular/common', '@angular/forms', '@angular/platform-browser', 'rxjs/Subject', 'rxjs/Observable', 'rxjs/BehaviorSubject', 'rxjs/add/observable/empty', 'rxjs/add/observable/from', 'rxjs/add/observable/of', 'rxjs/add/operator/distinctUntilChanged', 'rxjs/add/operator/combineLatest', 'rxjs/add/operator/mergeMap', 'rxjs/add/operator/toArray', 'rxjs/add/operator/filter', 'rxjs/add/operator/share', 'rxjs/add/operator/merge', 'rxjs/add/operator/map', 'rxjs/add/operator/do', 'lodash', 'escape-string-regexp'], factory) :
	(factory((global['ngx-select-ex'] = {}),global.ng.core,global.ng.common,global.ng.forms,global.ng.platformBrowser,global.Rx,global.Rx,global.Rx,global.Rx.Observable,global.Rx.Observable,global.Rx.Observable,global.Rx.Observable.prototype,global.Rx.Observable.prototype,global.Rx.Observable.prototype,global.Rx.Observable.prototype,global.Rx.Observable.prototype,global.Rx.Observable.prototype,global.Rx.Observable.prototype,global.Rx.Observable.prototype,global.Rx.Observable.prototype,global['']['/node_modules/lodash/index'].js,global['']['/node_modules/escape-string-regexp/index'].js));
}(this, (function (exports,core,common,forms,platformBrowser,Subject,Observable,BehaviorSubject,empty,from,of,distinctUntilChanged,combineLatest,mergeMap,toArray,filter,share,merge,map,_do,lodashNs,escapeStringNs) { 'use strict';
